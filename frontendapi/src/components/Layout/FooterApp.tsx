      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul>
              <li><a href="mailto:contacto@mangakami.com" className="text-indigo-500 hover:text-indigo-300">contacto@mangakami.com</a></li>
              <li><a href="mailto:soporte@mangakami.com" className="text-indigo-500 hover:text-indigo-300">soporte@mangakami.com</a></li>
              <li><a href="mailto:ventas@mangakami.com" className="text-indigo-500 hover:text-indigo-300">ventas@mangakami.com</a></li>
              <li><a href="mailto:marketing@mangakami.com" className="text-indigo-500 hover:text-indigo-300">marketing@mangakami.com</a></li>
              <li><a href="mailto:administracion@mangakami.com" className="text-indigo-500 hover:text-indigo-300">administracion@mangakami.com</a></li>

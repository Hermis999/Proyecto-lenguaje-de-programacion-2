    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-2">
                <img src={logo} alt="MngaKami" className="h-12 w-12 transform transition-transform duration-300 hover:scale-110" />
                <span className="text-4xl font-extrabold tracking-tight">MangaKami</span>
            </div>
            ...
            <div className="relative">
                ...
                <button
                    ...
                    className="flex items-center gap-2 p-2 rounded-full hover:bg-violet-400 focus:outline-none"
                >
